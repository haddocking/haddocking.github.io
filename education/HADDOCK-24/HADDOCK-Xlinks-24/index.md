---
layout: page
title: "HADDOCK 2.4 tutorial for the use of MS crosslink data to guide docking"
excerpt: "A small tutorial on the use of MS crosslinks data in HADDOCK 2.4."
...
([Leitner et al., 2014](https://doi.org/10.1073/pnas.1320298111)). The tutorial builds on our [DisVis tutorial](/education/HADDOCK-24/Others/disvis-webserver)
...
much since by default HADDOCK will randomly delete for each model a fraction of the provided data.
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/PRE5-interface.png">
</figure>
<br>
</details>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/PUP2-interface.png">
</figure>
<br>
</details>
...
For setting up the docking runs we will be using the expert access level of the
HADDOCK server for scenarios 1 and 3 and the easy access level for scenario 2.
...
## Setting up the docking with cross-links (scenario 1)
...
* **Step 1:** Define a name for your docking run, e.g. *PRE5-PUP2-MS-crosslinks*.

* **Step 2 :** Input the first protein PDB file. For this unfold the **First Molecule menu**.
...
* **Step 3:** Input the second protein PDB files. For this unfold the **Second Molecule menu**.
...
<a class="prompt prompt-info">
Upload the cross-links distance restraints file you created under the unambiguous distance restraints.
</a>
<a class="prompt prompt-info">
...
* **Step 6:** Click on the "Submit" button at the bottom left of the interface.
...
<figure align="center">
<img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/submission.png">
</figure>

Currently your run should be queued but eventually its status will change to “Running”:

<figure align="center">
<img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/running.png">
</figure>
...
For this scenario we will make us of [HADDOCK 2.4 interface](https://wenmr.science.uu.nl/haddock2.4/submit/1) after registering [here](https://nestor.science.uu.nl/auth/register/).
...
* **Step 5:** Specify the active residues for the first molecule. For this unfold the "Molecule 1 - parameters" in the **Input parameters window**.
...
* **Step 7:** Click on the "Next" button at the bottom left of the interface. Since we defined the active and passive residues already, we do not specify any additional restraints in this part.  Click on the "Submit" button at the bottom left of the interface.
...
<figure align="center">
<img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/HADDOCK-result-page.png">
...
<figure align="center">
<img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/HADDOCK-result-graph.png">
</figure>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/PRE5-PUP2-crosslinks.png">
</figure>
<br>
</details>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/cluster1-crosslinks-surface.png">
</figure>
<br>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/cluster10-interface-surface.png">
</figure>
<br>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/cluster1-crosslinks-interface-surface.png">
</figure>
<br>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/crosslinks-interface-vs-xray.png">
</figure>
<br>
...
<figure align="center">
  <img src="/education/HADDOCK-24/HADDOCK-Xlinks-24/crosslinks-vs-xray.png">
</figure>
<br>
