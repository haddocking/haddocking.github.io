...
For the docking of MDM2 and p53, define **active** residues on MDM2 based on [ARCTIC-3D](https://wenmr.science.uu.nl/arctic3d/){:target="_blank"} outpit. As there is no information about interacting residues of the peptide, define entire p53 as **passive**.
