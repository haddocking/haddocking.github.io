...
<a class="prompt prompt-cmd">wget https://files.rcsb.org/download/1JEJ.pdb</a>
...
<a class="prompt prompt-cmd"> cd ../ ; tar xvzf tutorial_files.tgz </a>
...
so, go in the `MD/plain` directory and type:
