...
This example follows the protocol described in our protein-peptide docking article ([Trellet et. al. PLoS ONE 8, e58769 (2013)](https://dx.plos.org/10.1371/journal.pone.0058769){:target="_blank"}).
...
Those were built using PyMol (instructions on how to do that can be found [here](https://www.bonvinlab.org/education/molmod_online/simulation/#preparing-the-system){:target="_blank"}).

Three different workflows are illustrated:

- 3000 rigidbody docking models, selection of top 400 and flexible refinement and energy minimisation of those ([docking-protein-peptide-full.cfg](https://github.com/haddocking/haddock3/tree/main/examples/docking-protein-peptide/docking-protein-peptide-full.cfg){:target="_blank"}
- 3000 rigidbody docking models, selection of top 400 and flexible refinement followed by a final refinement in explicit solvent (water) of those ([docking-protein-peptide-mdref-full.cfg](https://github.com/haddocking/haddock3/tree/main/examples/docking-protein-peptide/docking-protein-peptide-mdref-full.cfg){:target="_blank"}
- 3000 rigidbody docking models, FCC clustering and selection of max 20 models per cluster followed by flexible refinement and energy minimisation ([docking-protein-peptide-cltsel-full.cfg](https://github.com/haddocking/haddock3/tree/main/examples/docking-protein-peptide/docking-protein-peptide-cltsel-full.cfg){:target="_blank"}).
